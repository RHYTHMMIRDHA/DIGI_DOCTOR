    ...
    <div>
        ...
        <div>
          {doctors.slice(0, 3).map((item, index) => (
            <div className='gird grid-vols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
              <div>
              ...
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <p className='text-xs mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time : </span> 25 Aug, 2026 | 11 : 30 PM</p>
              </div>
